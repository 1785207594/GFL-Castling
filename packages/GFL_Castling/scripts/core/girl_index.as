...
dictionary tdoll_complex_index = {
    ...
    {modded_key(6,11007).toString(),"gkw_tt33_11007.weapon"},
    ...
    {modded_key(25,10808).toString(),"gkw_mp40_10808.weapon"},
    ...
    {modded_key(68).toString(),"gkw_l85a1.weapon"},
    ...
    {modded_key(74).toString(),"gkw_sig510.weapon"},
    ...
    {modded_key(159,10807).toString(),"gkw_rmb93_10807.weapon"},
    {modded_key(159,0,"mod3").toString(),"gkw_rmb93mod3.weapon"},
    {modded_key(159,4309,"mod3").toString(),"gkw_rmb93mod3_4309.weapon"},
    {modded_key(159,10807,"mod3").toString(),"gkw_rmb93mod3_10807.weapon"},
    ...
    {modded_key(193).toString(),"gkw_t65.weapon"},
    ...
    {modded_key(196,0,"mod3").toString(),"gkw_zasm21mod3.weapon"},
    {modded_key(196,2104).toString(),"gkw_zasm21_2104.weapon"},
    {modded_key(196,2104,"mod3").toString(),"gkw_zasm21mod3_2104.weapon"},
    ...
    {modded_key(202,3309).toString(),"gkw_thunder_3309.weapon"},
    ...
    {modded_key(217).toString(),"gkw_sm1.weapon"},
    ...
    {modded_key(226).toString(),"gkw_mk12.weapon"},
    ...
    {modded_key(267).toString(),"gkw_mp41.weapon"},
    {modded_key(267,0,"mod3").toString(),"gkw_mp41mod3.weapon"},
    ...
    {modded_key(279).toString(),"gkw_insas.weapon"},
    ...
    {modded_key(314).toString(),"gkw_stg940.weapon"},
    ...
    {modded_key(323,10803).toString(),"gkw_ltlx7000_10803.weapon"},
    ...
    {modded_key(373).toString(),"gkw_cmr30.weapon"},
...
array<string> gk_weapon_rf_list = { 
    ...
    "gkw_gm6.weapon",
    "gkw_liu_skill.weapon",
    "gkw_liu_563_skill.weapon",
    "gkw_liu_5101_skill.weapon",    
    "gkw_vsk94.weapon",
