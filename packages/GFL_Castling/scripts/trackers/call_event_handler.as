            ...
            if (phase == "launch") {
                switch(int(callLaunchIndex[callKey]))
                {
                    ...
                    case 16:{
                        ...
                        int vehicle_number_exist = getNumberedVehicle(m_metagame,factionId,"elmostore.vehicle");
                        if(vehicle_number_exist >= 3)
                        {
                            notify(m_metagame, "vehicle limited", dictionary(), "misc", playerId, false, "", 1.0);
                            addItemInBackpack(m_metagame,characterId,"weapon","fairy_vehicle_elmotruck.weapon");
                            break;                            
...
dictionary call_tier_index = {
    ...
    // T2 003 勇士妖精-[侦察直升机扫荡]
        ...
        {"t2_warrior_fairy_recon_heli_update_gamma",200303},
